/**
 * 이탈리아 스킵된 카테고리 수집 스크립트
 * 교육, 뉴스/정치, 인물/블로그, 노하우/스타일, 기타 카테고리 수집
 */
...
// 스킵된 카테고리 키워드 (확대)
const MISSING_CATEGORY_KEYWORDS = {
  education: [
    ...
    "scuola online", "università online", "corsi online italiani",
    "italian school", "italian university", "italian online courses",
    "apprendimento italiano", "formazione italiana", "didattica italiana"
  ],
  news: [
    ...
    "giornalismo italiano", "media italiani", "informazione italiana",
    "notizie attualità", "giornali online italiani", "telegiornale italiano"
  ],
  people: [
    ...
    "vlogger italia", "influencer italia", "creatore italiano",
    "italian lifestyle", "italian daily vlog", "italian personal channel"
  ],
  howto: [
    ...
    "tutorial italiani", "guide italiane", "consigli pratici italiani",
    "italian how to", "italian diy", "italian tips and tricks"
  ],
  other: [
    "italian youtuber", "italian channel", "italy youtuber", "italy channel",
    "youtuber italiani", "canali italiani", "creatori italiani",
    "top italian youtubers", "best italian channels", "popular italian creators",
    "most subscribed italian", "most viewed italian",
    "italian content", "italy content", "italian creators",
    "famosi youtuber italiani", "migliori canali italiani", "popolari creator italiani"
  ],
};
...
// 메인 실행
async function main() {
  console.log("🚀 이탈리아 스킵된 카테고리 수집 시작...\n");
  console.log(`📊 목표: 교육, 뉴스/정치, 인물/블로그, 노하우/스타일, 기타 카테고리 최소 200개 이상\n`);
  ...
  try {
    ...
    for (const category of missingCategories) {
      ...
      const keywords = MISSING_CATEGORY_KEYWORDS[category.id as keyof typeof MISSING_CATEGORY_KEYWORDS] || [];
