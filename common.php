...
//------------------------------------------------------------------------------
// magic_quotes_gpc 에 의한 backslashes 제거 (PHP 8.0+ 호환)
...
// PHP 8.x 호환성: $_SESSION 초기화
if (!isset($_SESSION)) {
    $_SESSION = array();
}

// UTF-8 인코딩 헤더 설정 (세션 시작 후 출력)
if (!headers_sent()) {
...
if ($bo_table) {
    ...
    if ($board && isset($board['bo_table']) && $board['bo_table']) {
...
//------------------------------------------------------------------------------
if (G5_IS_MOBILE) {
    $board_skin_path    = get_skin_path('board', isset($board['bo_mobile_skin']) ? $board['bo_mobile_skin'] : '');
    $board_skin_url     = get_skin_url('board', isset($board['bo_mobile_skin']) ? $board['bo_mobile_skin'] : '');
    ...
    $board_skin_path    = get_skin_path('board', isset($board['bo_skin']) ? $board['bo_skin'] : '');
    $board_skin_url     = get_skin_url('board', isset($board['bo_skin']) ? $board['bo_skin'] : '');
